...
function tournament() {
    ...
    function checkMatchOver() {
        if (currentMatch.leftPlayer.score >= 5 || currentMatch.rightPlayer.score >= 5) {
            let winner = currentMatch.leftPlayer.score >= 5 ? currentMatch.leftPlayer : currentMatch.rightPlayer;
            let loser = currentMatch.leftPlayer.score >= 5 ? currentMatch.rightPlayer : currentMatch.leftPlayer;
