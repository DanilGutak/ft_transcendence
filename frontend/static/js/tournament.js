...
function tournament() {
  ...
  function checkMatchOver() {
      if (currentMatch.leftPlayer.score >= maxScore || currentMatch.rightPlayer.score >= maxScore) {
          let winner = currentMatch.leftPlayer.score >= maxScore ? currentMatch.leftPlayer : currentMatch.rightPlayer;
          let loser = currentMatch.leftPlayer.score >= maxScore ? currentMatch.rightPlayer : currentMatch.leftPlayer;
  ...
  function render() {
      ...
      context.fillText(`${currentMatch.leftPlayer.name} vs ${currentMatch.rightPlayer.name}`, canvas.width / 2 - 100, 50);
